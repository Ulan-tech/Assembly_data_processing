...
#%% Loding data
data = pd.read_csv(r'C:\Users\kazak\PycharmProjects\Assembly_data_processing\Data\Table4.csv')
print(data.Time)
#%% converting to time
...
#%% Norm fitting it was used before the finding common range
...
fig, ax = plt.subplots()
lessthanX=norm.cdf(x=95.933, loc=52.357, scale=22.361)
print(lessthanX)
px=np.arange(0,95.933,0.1)
ax.set_ylim(0,0.02)
ax.fill_between(px,norm.pdf(px,loc=52.357, scale=22.361),alpha=0.5, color='b')
ax.text(0,0.0180, "p= ", fontsize=18)
ax.text(16,0.0180, round(lessthanX,3), fontsize=15)
